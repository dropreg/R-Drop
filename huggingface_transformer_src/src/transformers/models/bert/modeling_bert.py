...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(
        ...
        # loss, logits, outputs = self.bert_cross_entropy(input_ids, attention_mask, token_type_ids, position_ids, head_mask, inputs_embeds,
        #                                                 labels, output_attentions, output_hidden_states, return_dict)
        loss, logits, outputs = self.bert_kl(input_ids, attention_mask, token_type_ids, position_ids, head_mask, inputs_embeds,
                                             labels, output_attentions, output_hidden_states, return_dict)
        if not return_dict:
